...
import com.ll.exam.app10.app.article.respository.ArticleRepository;
...
public class ArticleService {
    ...
    public Article write(Member author, String subject, String content) {        Article article = Article
                .builder()
                .author(author)
                .subject(subject)
                .content(content)
